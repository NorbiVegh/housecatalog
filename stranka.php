                ...
                <div class="col-lg-9">
                    <div class="row gx-0 bg-white d-none d-lg-flex">
                        <div class="col-lg-7 px-5 text-start">
                            ...
                            <div class="h-100 d-inline-flex align-items-center py-2 ps-4">
                                <i class="fa fa-user text-primary me-2"></i>
                                <p class="mb-0">Vitaj, <span><?php echo $_SESSION["user_name"]?></span> </p>
                            </div>
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            ...
                            <!--tlacidlo-->
                            <a href="logout.php" class="btn btn-primary rounded-0 py-4 px-md-5 d-none d-lg-block">Odhlásiť sa<i class="fa fa-arrow-right ms-3"></i>
                            </a>
                        </div>
                    </nav>
                </div>
